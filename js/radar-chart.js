  ...
  var cfg = {
	...
	d.forEach(function(y, x){
	  g.selectAll(".nodes")
		.data(y).enter()
		.append("svg:circle")
		.attr("class", function(j){return j.axis +" "+ cfg.gender})
		.attr('r', cfg.radius)
		...
		.on('mouseover', function (d){
                    ...
                    var allCircl = d3.selectAll("."+d3.select(this).attr("data-id"));
                    allCircl.style('fill',"#FF4242");
					z = "polygon.radar-chart-serie"+series;
					g.selectAll("polygon")
						.transition(200)
